...
// Workspace product logos: fonts.gstatic.com/s/i/productlogos/ (official CDN, SVG)
...
// Verified CDN paths (2026-06-22). All return 192px SVG — scales to any size.
var _WORKSPACE_LOGOS = {
  gmail:      'gmail/v9',
  drive:      'drive/v2',
  docs:       'docs_2020q4/v6',
  sheets:     'sheets_2020q4/v6',
  slides:     'slides_2020q4/v6',
  calendar:   'calendar_2020q4/v6',
  meet:       'meet_2020q4/v6',
  forms:      'forms_2020q4/v6',
  chat:       'chat_2020q4/v6',
  classroom:  'classroom/v4',
  keep:       'keep/v7',
  sites:      'sites/v2',
  vault:      'vault/v2',
  groups:     'groups/v3',
  tasks:      'tasks/v3',
  contacts:   'contacts/v3',
  jamboard:   'jamboard/v2',
  admin:      'admin/v6',
  appsheet:   'appsheet/v1',
  currents:   'currents/v2'
};
...
_RENDERERS['workspace_logo'] = function(b) {
  ...
  var src = _LOGO_BASE + path + '/192px.svg';
  return '<span style="' + wrapStyle + '">'
...
_RENDERERS['workspace_logo_strip'] = function(b) {
  ...
  var logos = apps.map(function(app) {
    ...
    return '<img src="' + _LOGO_BASE + path + '/192px.svg" width="' + size + '" height="' + size
